...
__attribute__((swift_name("BaseCameraSdk")))
@protocol GNCBaseCameraSdk
@required
@property (readonly) id<GNCNavigationCameraHandler> navigationCameraHandler __attribute__((swift_name("navigationCameraHandler")));
@end

__attribute__((swift_name("NavigationUISdk")))
@protocol GNCNavigationUISdk <GNCBaseCameraSdk>
@required
@property (readonly) id<GNCRouteDetachStateProvider> detachStateProvider __attribute__((swift_name("detachStateProvider")));
@property (readonly) id<GNCLocationProvider> userInterfaceLocationProvider __attribute__((swift_name("userInterfaceLocationProvider")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BaseNavigationUISdk")))
@interface GNCBaseNavigationUISdk : GNCBase <GNCNavigationUISdk>
- (instancetype)initWithNavigationSdk:(id<GNCNavigationSdk>)navigationSdk screenHeightProvider:(id<GNCScreenHeightProvider>)screenHeightProvider executor:(id<GNCExecutor>)executor __attribute__((swift_name("init(navigationSdk:screenHeightProvider:executor:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithNavigationSdk:(id<GNCNavigationSdk>)navigationSdk screenHeightProvider:(id<GNCScreenHeightProvider>)screenHeightProvider executor:(id<GNCExecutor>)executor updateRate:(GNCDuration *)updateRate __attribute__((swift_name("init(navigationSdk:screenHeightProvider:executor:updateRate:)"))) __attribute__((objc_designated_initializer));
@property (readonly) id<GNCRouteDetachStateProvider> detachStateProvider __attribute__((swift_name("detachStateProvider")));
@property (readonly) id<GNCNavigationCameraHandler> navigationCameraHandler __attribute__((swift_name("navigationCameraHandler")));
@property (readonly) id<GNCLocationProvider> userInterfaceLocationProvider __attribute__((swift_name("userInterfaceLocationProvider")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BaseCameraSdkCompanion")))
@interface GNCBaseCameraSdkCompanion : GNCBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) GNCBaseCameraSdkCompanion *shared __attribute__((swift_name("shared")));
...
- (GNCDouble * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCDuration * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCCameraUpdatePadding *)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
...
__attribute__((swift_name("ScreenHeightProvider")))
@protocol GNCScreenHeightProvider
@required
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (GNCSpeed *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSArray<GNCLatLng *> *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (UIImage *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (UIColor *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (UIColor *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (UIColor *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (UIColor * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
@property (class, readonly) GNCLaneAssistIconProviderLaneAssistIcon *troughLeft __attribute__((swift_name("troughLeft")));
@property (class, readonly) GNCLaneAssistIconProviderLaneAssistIcon *troughLeftUseLeft __attribute__((swift_name("troughLeftUseLeft")));
@property (class, readonly) GNCLaneAssistIconProviderLaneAssistIcon *troughLeftUseThrough __attribute__((swift_name("troughLeftUseThrough")));
@property (class, readonly) GNCLaneAssistIconProviderLaneAssistIcon *troughRight __attribute__((swift_name("troughRight")));
@property (class, readonly) GNCLaneAssistIconProviderLaneAssistIcon *troughRightUseRight __attribute__((swift_name("troughRightUseRight")));
@property (class, readonly) GNCLaneAssistIconProviderLaneAssistIcon *troughRightUseThrough __attribute__((swift_name("troughRightUseThrough")));
...
- (int32_t)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLatLng *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCTurnInfo *)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLaneInfo * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
...
@property NSString *serviceUrl __attribute__((swift_name("serviceUrl")));
...
- (instancetype)initWithExecutor:(id<GNCExecutor>)executor timeProvider:(id<GNCTimeProvider>)timeProvider sessionClient:(id<GNCSessionClient>)sessionClient routeProvider:(id<GNCRouteProvider>)routeProvider destinationReachedValidator:(id<GNCDestinationReachedValidator> _Nullable)destinationReachedValidator leavingDestinationValidator:(id<GNCLeavingDestinationValidator> _Nullable)leavingDestinationValidator internetConnectionValidator:(id<GNCInternetConnectionValidator> _Nullable)internetConnectionValidator updateRateProvider:(id<GNCUpdateRateProvider> _Nullable)updateRateProvider destinationRepository:(id<GNCDestinationRepository>)destinationRepository vehicleConfig:(id<GNCVehicleConfig>)vehicleConfig serviceUrl:(NSString *)serviceUrl __attribute__((swift_name("init(executor:timeProvider:sessionClient:routeProvider:destinationReachedValidator:leavingDestinationValidator:internetConnectionValidator:updateRateProvider:destinationRepository:vehicleConfig:serviceUrl:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((swift_name("BaseIosNavigationSdk")))
@interface GNCBaseIosNavigationSdk : GNCBaseNavigationSdk
- (instancetype)initWithSessionClient:(id<GNCSessionClient>)sessionClient routeProvider:(id<GNCRouteProvider>)routeProvider serviceUrl:(NSString *)serviceUrl __attribute__((swift_name("init(sessionClient:routeProvider:serviceUrl:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithSessionClient:(id<GNCSessionClient>)sessionClient routeProvider:(id<GNCRouteProvider>)routeProvider destinationReachedValidator:(id<GNCDestinationReachedValidator> _Nullable)destinationReachedValidator leavingDestinationValidator:(id<GNCLeavingDestinationValidator> _Nullable)leavingDestinationValidator internetConnectionValidator:(id<GNCInternetConnectionValidator> _Nullable)internetConnectionValidator updateRateProvider:(id<GNCUpdateRateProvider> _Nullable)updateRateProvider destinationRepository:(id<GNCDestinationRepository>)destinationRepository vehicleConfig:(id<GNCVehicleConfig>)vehicleConfig serviceUrl:(NSString *)serviceUrl __attribute__((swift_name("init(sessionClient:routeProvider:destinationReachedValidator:leavingDestinationValidator:internetConnectionValidator:updateRateProvider:destinationRepository:vehicleConfig:serviceUrl:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithExecutor:(id<GNCExecutor>)executor timeProvider:(id<GNCTimeProvider>)timeProvider sessionClient:(id<GNCSessionClient>)sessionClient routeProvider:(id<GNCRouteProvider>)routeProvider destinationReachedValidator:(id<GNCDestinationReachedValidator> _Nullable)destinationReachedValidator leavingDestinationValidator:(id<GNCLeavingDestinationValidator> _Nullable)leavingDestinationValidator internetConnectionValidator:(id<GNCInternetConnectionValidator> _Nullable)internetConnectionValidator updateRateProvider:(id<GNCUpdateRateProvider> _Nullable)updateRateProvider destinationRepository:(id<GNCDestinationRepository>)destinationRepository vehicleConfig:(id<GNCVehicleConfig>)vehicleConfig serviceUrl:(NSString *)serviceUrl __attribute__((swift_name("init(executor:timeProvider:sessionClient:routeProvider:destinationReachedValidator:leavingDestinationValidator:internetConnectionValidator:updateRateProvider:destinationRepository:vehicleConfig:serviceUrl:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@end
...
+ (instancetype)new __attribute__((unavailable));
- (GNCLength *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<GNCLaneInfoLane *> *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (instancetype)initWithTurns:(NSArray<GNCLaneInfoLaneLaneTurn *> *)turns directionNames:(NSArray<NSString *> *)directionNames directionReferenceNames:(NSArray<NSString *> *)directionReferenceNames usable:(BOOL)usable __attribute__((swift_name("init(turns:directionNames:directionReferenceNames:usable:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSArray<GNCLaneInfoLaneLaneTurn *> *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<NSString *> *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCLaneInfoLane *)doCopyTurns:(NSArray<GNCLaneInfoLaneLaneTurn *> *)turns directionNames:(NSArray<NSString *> *)directionNames directionReferenceNames:(NSArray<NSString *> *)directionReferenceNames usable:(BOOL)usable __attribute__((swift_name("doCopy(turns:directionNames:directionReferenceNames:usable:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (NSArray<GNCRouteDestinationInfo *> *)component10 __attribute__((swift_name("component10()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLatLng *)component11 __attribute__((swift_name("component11()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCDuration *)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (GNCRouteEnforcementType *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCSpeed * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLatLng *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<GNCLatLng *> *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSArray<GNCRouteFuelStationType *> *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
+ (instancetype)new __attribute__((unavailable));
- (int32_t)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCRouteWaypoint *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCRouteWaypoint *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCTurnInfo * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLaneInfo * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSDictionary<NSString *, id> *)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (BOOL)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCSpeed * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCRoadClass *)component8 __attribute__((swift_name("component8()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCRouteWaypointGpsQuality *)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCTurnInfoStreetSide *)component10 __attribute__((swift_name("component10()"))) __attribute__((deprecated("use corresponding property instead")));
- (BOOL)component11 __attribute__((swift_name("component11()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCRoadClass *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (float)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCOnRouteProjectorProjectedLocation *)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (int32_t)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLength * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
+ (instancetype)new __attribute__((unavailable));
- (GNCLength *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCInt * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCRouteWaypoint * _Nullable)component14 __attribute__((swift_name("component14()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLength *)component15 __attribute__((swift_name("component15()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCDuration *)component16 __attribute__((swift_name("component16()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCDuration *)component17 __attribute__((swift_name("component17()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLong * _Nullable)component18 __attribute__((swift_name("component18()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCSpeed * _Nullable)component19 __attribute__((swift_name("component19()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSArray<GNCDuration *> *)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<GNCRouteWaypoint *> *)component8 __attribute__((swift_name("component8()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCOnRouteProjectorProjectedLocation *)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (id<GNCRoutable>)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCDouble * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCLatLng * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (instancetype)initWithHash:(NSString *)hash vehicleType:(NSString * _Nullable)vehicleType destinationInfo:(NSArray<GNCRouteDtoDestinationInfo *> * _Nullable)destinationInfo duration:(NSString * _Nullable)duration length:(double)length nextRefreshInterval:(NSString *)nextRefreshInterval routeLegs:(NSArray<GNCRouteDtoRouteLeg *> * _Nullable)routeLegs trafficVolume:(NSString * _Nullable)trafficVolume localizedInfo:(NSString * _Nullable)localizedInfo offRoute:(GNCBoolean * _Nullable)offRoute __attribute__((swift_name("init(hash:vehicleType:destinationInfo:duration:length:nextRefreshInterval:routeLegs:trafficVolume:localizedInfo:offRoute:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCBoolean * _Nullable)component10 __attribute__((swift_name("component10()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<GNCRouteDtoDestinationInfo *> * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (NSArray<GNCRouteDtoRouteLeg *> * _Nullable)component7 __attribute__((swift_name("component7()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (double)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<NSString *> * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (double)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCInt * _Nullable)component10 __attribute__((swift_name("component10()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<GNCRouteDtoGeoPoint *> *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<GNCRouteDtoEnforcement *> * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSArray<GNCRouteDtoRouteLegStepLane *> * _Nullable)component5 __attribute__((swift_name("component5()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCDouble * _Nullable)component6 __attribute__((swift_name("component6()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (GNCRouteDtoRouteLegStepTurnInfo *)component9 __attribute__((swift_name("component9()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (instancetype)initWithLaneTurns:(NSArray<NSString *> *)laneTurns directionNames:(NSArray<NSString *> *)directionNames directionReferenceNames:(NSArray<NSString *> *)directionReferenceNames shouldUse:(BOOL)shouldUse __attribute__((swift_name("init(laneTurns:directionNames:directionReferenceNames:shouldUse:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (NSArray<NSString *> *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (BOOL)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (GNCRouteDtoRouteLegStepLane *)doCopyLaneTurns:(NSArray<NSString *> *)laneTurns directionNames:(NSArray<NSString *> *)directionNames directionReferenceNames:(NSArray<NSString *> *)directionReferenceNames shouldUse:(BOOL)shouldUse __attribute__((swift_name("doCopy(laneTurns:directionNames:directionReferenceNames:shouldUse:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSArray<NSString *> *directionNames __attribute__((swift_name("directionNames")));
@property NSArray<NSString *> *directionReferenceNames __attribute__((swift_name("directionReferenceNames")));
...
@interface GNCDuration : GNCFreezable <GNCSerializable, GNCKotlinComparable>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
@interface GNCLength : GNCFreezable <GNCKotlinComparable, GNCSerializable>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (double)kilometers __attribute__((swift_name("kilometers()")));
- (double)meters __attribute__((swift_name("meters()")));
- (double)miles __attribute__((swift_name("miles()")));
- (GNCLength *)minusDecrement:(GNCLength *)decrement __attribute__((swift_name("minus(decrement:)")));
- (GNCLength *)plusIncrement:(GNCLength *)increment __attribute__((swift_name("plus(increment:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@interface GNCSpeed : GNCFreezable <GNCSerializable>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
...
- (GNCSpeed *)doCopyMetersPerSecond:(double)metersPerSecond __attribute__((swift_name("doCopy(metersPerSecond:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
...
- (id<GNCKotlinCoroutineContextElement> _Nullable)getKey:(id<GNCKotlinCoroutineContextKey>)key __attribute__((swift_name("get(key:)")));
...
- (void)cancelCause:(GNCKotlinCancellationException * _Nullable)cause __attribute__((swift_name("cancel(cause:)")));
...
@protocol GNCSelectClause0
@required
- (void)registerSelectClause0Select:(id<GNCSelectInstance>)select block:(id<GNCKotlinSuspendFunction0>)block __attribute__((swift_name("registerSelectClause0(select:block:)")));
@end

__attribute__((swift_name("JobSupport")))
@interface GNCJobSupport : GNCBase <GNCJob, GNCChildJob, GNCParentJob, GNCSelectClause0>
...
@required
- (BOOL)cancelCause_:(GNCKotlinThrowable * _Nullable)cause __attribute__((swift_name("cancel(cause_:)")));
...
- (void)cancelCause:(GNCKotlinCancellationException * _Nullable)cause __attribute__((swift_name("cancel(cause:)"))) __attribute__((deprecated("NonCancellable can be used only as an argument for 'withContext', direct usages of its API are prohibited")));
 ...
 *   kotlinx.coroutines.ExperimentalCoroutinesApi
*/
- (void)onTimeoutTimeMillis:(int64_t)timeMillis block:(id<GNCKotlinSuspendFunction0>)block __attribute__((swift_name("onTimeout(timeMillis:block:)")));
...
@protocol GNCSelectClause1
@required
- (void)registerSelectClause1Select:(id<GNCSelectInstance>)select block:(id<GNCKotlinSuspendFunction1>)block __attribute__((swift_name("registerSelectClause1(select:block:)")));
@end

__attribute__((swift_name("SelectClause2")))
@protocol GNCSelectClause2
@required
- (void)registerSelectClause2Select:(id<GNCSelectInstance>)select param:(id _Nullable)param block:(id<GNCKotlinSuspendFunction1>)block __attribute__((swift_name("registerSelectClause2(select:param:block:)")));
@end

__attribute__((swift_name("SelectInstance")))
@protocol GNCSelectInstance
@required
- (void)disposeOnSelectHandle:(id<GNCDisposableHandle>)handle __attribute__((swift_name("disposeOnSelect(handle:)")));
- (id _Nullable)performAtomicTrySelectDesc:(GNCAtomicDesc *)desc __attribute__((swift_name("performAtomicTrySelect(desc:)")));
- (void)resumeSelectWithExceptionException:(GNCKotlinThrowable *)exception __attribute__((swift_name("resumeSelectWithException(exception:)")));
- (BOOL)trySelect __attribute__((swift_name("trySelect()")));
- (id _Nullable)trySelectOtherOtherOp:(GNCLockFreeLinkedListNodePrepareOp * _Nullable)otherOp __attribute__((swift_name("trySelectOther(otherOp:)")));
@property (readonly) id<GNCKotlinContinuation> completion __attribute__((swift_name("completion")));
...
@property GNCAtomicOp<id> *atomicOp __attribute__((swift_name("atomicOp")));
@end
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (BOOL)isEarlierThanThat:(GNCOpDescriptor *)that __attribute__((swift_name("isEarlierThan(that:)")));
- (id _Nullable)performAffected:(id _Nullable)affected __attribute__((swift_name("perform(affected:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) GNCAtomicOp<id> * _Nullable atomicOp __attribute__((swift_name("atomicOp")));
@end
...
@property (readonly) GNCAtomicOp<id> *atomicOp __attribute__((swift_name("atomicOp")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (GNCLockFreeLinkedListNode * _Nullable)nextIfRemoved __attribute__((swift_name("nextIfRemoved()")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (id _Nullable)failureAffected:(GNCLockFreeLinkedListNode *)affected __attribute__((swift_name("failure(affected:)")));
...
- (void)finishPreparePrepareOp:(GNCLockFreeLinkedListNodePrepareOp *)prepareOp __attribute__((swift_name("finishPrepare(prepareOp:)")));
- (id _Nullable)onPreparePrepareOp:(GNCLockFreeLinkedListNodePrepareOp *)prepareOp __attribute__((swift_name("onPrepare(prepareOp:)")));
- (void)onRemovedAffected:(GNCLockFreeLinkedListNode *)affected __attribute__((swift_name("onRemoved(affected:)")));
- (id _Nullable)prepareOp:(GNCAtomicOp<id> *)op __attribute__((swift_name("prepare(op:)")));
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (GNCLockFreeLinkedListNode * _Nullable)takeAffectedNodeOp:(GNCOpDescriptor *)op __attribute__((swift_name("takeAffectedNode(op:)")));
...
@interface GNCLockFreeLinkedListNodePrepareOp : GNCOpDescriptor
- (instancetype)initWithAffected:(GNCLockFreeLinkedListNode *)affected next:(GNCLockFreeLinkedListNode *)next desc:(GNCLockFreeLinkedListNodeAbstractAtomicDesc *)desc __attribute__((swift_name("init(affected:next:desc:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (void)finishPrepare __attribute__((swift_name("finishPrepare()")));
- (id _Nullable)performAffected:(id _Nullable)affected __attribute__((swift_name("perform(affected:)")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) GNCLockFreeLinkedListNode *affected __attribute__((swift_name("affected")));
@property (readonly) GNCAtomicOp<id> *atomicOp __attribute__((swift_name("atomicOp")));
@property (readonly) GNCLockFreeLinkedListNodeAbstractAtomicDesc *desc __attribute__((swift_name("desc")));
@property (readonly) GNCLockFreeLinkedListNode *next __attribute__((swift_name("next")));
@end
 ...
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
- (NSString *)elementNameDesc:(id<GNCSerialDescriptor>)desc index:(int32_t)index __attribute__((swift_name("elementName(desc:index:)")));
...
- (void)defaultDefaultSerializerProvider:(id<GNCDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultSerializerProvider __attribute__((swift_name("default(defaultSerializerProvider:)")));
...
- (void)polymorphicDefaultBaseClass:(id<GNCKotlinKClass>)baseClass defaultDeserializerProvider:(id<GNCDeserializationStrategy> _Nullable (^)(NSString * _Nullable))defaultDeserializerProvider __attribute__((swift_name("polymorphicDefault(baseClass:defaultDeserializerProvider:)")));
...
- (double)timeInterval __attribute__((swift_name("timeInterval()")));
...
- (GNCLength *)distanceFromLocation:(GNCLocation *)location __attribute__((swift_name("distanceFrom(location:)")));
@property (readonly) CLLocation *clLocation __attribute__((swift_name("clLocation")));
@end

@interface GNCLocationCompanion (Extensions)
- (GNCLocation *)fromLatLng:(GNCLatLng *)latLng __attribute__((swift_name("from(latLng:)")));
...
*/
- (int64_t)daysValue:(double)value __attribute__((swift_name("days(value:)"))) __attribute__((deprecated("Use 'Double.days' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)daysValue_:(int32_t)value __attribute__((swift_name("days(value_:)"))) __attribute__((deprecated("Use 'Int.days' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)daysValue__:(int64_t)value __attribute__((swift_name("days(value__:)"))) __attribute__((deprecated("Use 'Long.days' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)hoursValue:(double)value __attribute__((swift_name("hours(value:)"))) __attribute__((deprecated("Use 'Double.hours' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)hoursValue_:(int32_t)value __attribute__((swift_name("hours(value_:)"))) __attribute__((deprecated("Use 'Int.hours' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)hoursValue__:(int64_t)value __attribute__((swift_name("hours(value__:)"))) __attribute__((deprecated("Use 'Long.hours' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)microsecondsValue:(double)value __attribute__((swift_name("microseconds(value:)"))) __attribute__((deprecated("Use 'Double.microseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)microsecondsValue_:(int32_t)value __attribute__((swift_name("microseconds(value_:)"))) __attribute__((deprecated("Use 'Int.microseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)microsecondsValue__:(int64_t)value __attribute__((swift_name("microseconds(value__:)"))) __attribute__((deprecated("Use 'Long.microseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)millisecondsValue:(double)value __attribute__((swift_name("milliseconds(value:)"))) __attribute__((deprecated("Use 'Double.milliseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)millisecondsValue_:(int32_t)value __attribute__((swift_name("milliseconds(value_:)"))) __attribute__((deprecated("Use 'Int.milliseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)millisecondsValue__:(int64_t)value __attribute__((swift_name("milliseconds(value__:)"))) __attribute__((deprecated("Use 'Long.milliseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)minutesValue:(double)value __attribute__((swift_name("minutes(value:)"))) __attribute__((deprecated("Use 'Double.minutes' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)minutesValue_:(int32_t)value __attribute__((swift_name("minutes(value_:)"))) __attribute__((deprecated("Use 'Int.minutes' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)minutesValue__:(int64_t)value __attribute__((swift_name("minutes(value__:)"))) __attribute__((deprecated("Use 'Long.minutes' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)nanosecondsValue:(double)value __attribute__((swift_name("nanoseconds(value:)"))) __attribute__((deprecated("Use 'Double.nanoseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)nanosecondsValue_:(int32_t)value __attribute__((swift_name("nanoseconds(value_:)"))) __attribute__((deprecated("Use 'Int.nanoseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)nanosecondsValue__:(int64_t)value __attribute__((swift_name("nanoseconds(value__:)"))) __attribute__((deprecated("Use 'Long.nanoseconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)secondsValue:(double)value __attribute__((swift_name("seconds(value:)"))) __attribute__((deprecated("Use 'Double.seconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)secondsValue_:(int32_t)value __attribute__((swift_name("seconds(value_:)"))) __attribute__((deprecated("Use 'Int.seconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlin.DeprecatedSinceKotlin(warningSince="1.6")
*/
- (int64_t)secondsValue__:(int64_t)value __attribute__((swift_name("seconds(value__:)"))) __attribute__((deprecated("Use 'Long.seconds' extension property from Duration.Companion instead.")));
 ...
 *   kotlinx.coroutines.ObsoleteCoroutinesApi
*/
+ (id<GNCBroadcastChannel>)BroadcastChannelCapacity:(int32_t)capacity __attribute__((swift_name("BroadcastChannel(capacity:)")));
@end
 ...
 *   kotlinx.coroutines.ObsoleteCoroutinesApi
*/
+ (id<GNCBroadcastChannel>)broadcast:(id<GNCReceiveChannel>)receiver capacity:(int32_t)capacity start:(GNCCoroutineStart *)start __attribute__((swift_name("broadcast(_:capacity:start:)")));
@end
 ...
 *   kotlinx.coroutines.ObsoleteCoroutinesApi
*/
+ (id _Nullable)consume:(id<GNCBroadcastChannel>)receiver block:(id _Nullable (^)(id<GNCReceiveChannel>))block __attribute__((swift_name("consume(_:block:)")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)consumeEach:(id<GNCBroadcastChannel>)receiver action:(void (^)(id _Nullable))action completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("consumeEach(_:action:completionHandler:)")));
...
+ (id<GNCSelectClause1>)onReceiveOrNull:(id<GNCReceiveChannel>)receiver __attribute__((swift_name("onReceiveOrNull(_:)"))) __attribute__((unavailable("Deprecated in the favour of 'onReceiveCatching'")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
+ (void)receiveOrNull:(id<GNCReceiveChannel>)receiver completionHandler:(void (^)(id _Nullable_result, NSError * _Nullable))completionHandler __attribute__((swift_name("receiveOrNull(_:completionHandler:)"))) __attribute__((unavailable("Deprecated in the favour of 'receiveCatching'")));
...
+ (void)sendBlocking:(id<GNCSendChannel>)receiver element:(id _Nullable)element __attribute__((swift_name("sendBlocking(_:element:)"))) __attribute__((unavailable("Deprecated in the favour of 'trySendBlocking'. Consider handling the result of 'trySendBlocking' explicitly and rethrow exception if necessary")));
...
+ (id<GNCFlow>)asFlow:(id<GNCBroadcastChannel>)receiver __attribute__((swift_name("asFlow(_:)"))) __attribute__((deprecated("'BroadcastChannel' is obsolete and all corresponding operators are deprecated in the favour of StateFlow and SharedFlow")));
...
@interface GNCSdkKt : GNCBase
+ (GNCBaseNavigationUISdk *)BaseNavigationUISdkNavigationSdk:(id<GNCNavigationSdk>)navigationSdk screenHeightProvider:(id<GNCScreenHeightProvider>)screenHeightProvider __attribute__((swift_name("BaseNavigationUISdk(navigationSdk:screenHeightProvider:)")));
@end
...
- (GNCKotlinKVariance * _Nullable)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (id<GNCKotlinKType> _Nullable)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
